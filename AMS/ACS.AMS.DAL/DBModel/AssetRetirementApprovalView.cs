...
[Keyless]
public partial class AssetRetirementApprovalView : BaseEntityObject, IACSDBObject
{
...
/*
    ...
    public AssetRetirementApprovalView()
    {

    }

	/// <summary>
    /// Default constructor for AssetRetirementApprovalView
    /// </summary>
    /// <param name="db"></param>
	public AssetRetirementApprovalView(AMSContext _db)
	{
...
*/
	...
	internal override void BeforeSave(AMSContext db)
    {
		...
		if(!string.IsNullOrEmpty(this.TransactionSubType)) this.TransactionSubType = this.TransactionSubType.Trim();
    ...
    public static AssetRetirementApprovalView GetItem(AMSContext _db, int id)
    {
        return (from b in _db.AssetRetirementApprovalView
                where b.ApprovalHistoryID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<AssetRetirementApprovalView> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<AssetRetirementApprovalView> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return AssetRetirementApprovalView.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.AssetRetirementApprovalView select b);
    }
    ...
    {
        return AssetRetirementApprovalView.GetAllUserItems(_db, userID, includeInactiveItems);
    }
