...
[Keyless]
public partial class CategoryNewView : BaseEntityObject, IACSDBObject
{
...
/*
	...
	/// <summary>
    /// Default constructor for CategoryNewView
    /// </summary>
    /// <param name="db"></param>
	public CategoryNewView(AMSContext _db)
	{
...
*/
    ...
    public static CategoryNewView GetItem(AMSContext _db, int? id)
    {
        return (from b in _db.CategoryNewView
                where b.CategoryID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<CategoryNewView> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<CategoryNewView> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return CategoryNewView.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.CategoryNewView select b);
    }
    ...
    {
        return CategoryNewView.GetAllUserItems(_db, userID, includeInactiveItems);
    }
