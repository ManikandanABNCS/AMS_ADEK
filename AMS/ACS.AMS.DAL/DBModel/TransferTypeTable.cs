...
[Index("TransferTypeCode", Name = "UC_TransferTypeCode", IsUnique = true)]
public partial class TransferTypeTable : BaseEntityObject, IACSDBObject
{
    [Key]
    public int TransferTypeID { get; set; }

    [StringLength(100)]
    public string TransferTypeCode { get; set; } = null!;
    ...
    [InverseProperty("TransferTypeTableCreatedByNavigation")]
    public virtual User_LoginUserTable? CreatedByNavigation { get; set; } = null!;

    [ForeignKey("LastModifiedBy")]
    [InverseProperty("TransferTypeTableLastModifiedByNavigation")]
    public virtual User_LoginUserTable? LastModifiedByNavigation { get; set; }

    [ForeignKey("StatusID")]
    [InverseProperty("TransferTypeTable")]
...
/*
    ...
    public TransferTypeTable()
    {

    }

	/// <summary>
    /// Default constructor for TransferTypeTable
    /// </summary>
    /// <param name="db"></param>
	public TransferTypeTable(AMSContext _db)
	{
...
*/
    ...
    {
		if(!string.IsNullOrEmpty(this.TransferTypeCode)) this.TransferTypeCode = this.TransferTypeCode.Trim();
		...
		if(!string.IsNullOrEmpty(this.TransferTypeName)) this.TransferTypeName = this.TransferTypeName.Trim();
    ...
    public static TransferTypeTable GetItem(AMSContext _db, int id)
    {
        return (from b in _db.TransferTypeTable
                where b.TransferTypeID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<TransferTypeTable> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
        if(includeInactiveItems)
        {
            return (from b in _db.TransferTypeTable
                    where b.StatusID != (int) StatusValue.Deleted 
                    orderby b.TransferTypeID descending
                    select b);
        }
        else
        {
    ...
    public static IQueryable<TransferTypeTable> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return TransferTypeTable.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.TransferTypeTable select b);
    }
    ...
    {
        return TransferTypeTable.GetAllUserItems(_db, userID, includeInactiveItems);
    }
