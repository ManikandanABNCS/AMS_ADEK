...
[Keyless]
public partial class TransactionLineItemViewForTransfer : BaseEntityObject, IACSDBObject
{
    ...
    [Column(TypeName = "smalldatetime")]
    public DateTime TransactionCreatedDatetime { get; set; }
...
/*
    ...
    public TransactionLineItemViewForTransfer()
    {

    }

	/// <summary>
    /// Default constructor for TransactionLineItemViewForTransfer
    /// </summary>
    /// <param name="db"></param>
	public TransactionLineItemViewForTransfer(AMSContext _db)
	{
...
*/
	...
	internal override void BeforeSave(AMSContext db)
    {
		...
		if(!string.IsNullOrEmpty(this.OldLocationName)) this.OldLocationName = this.OldLocationName.Trim();
		if(!string.IsNullOrEmpty(this.NewLocationName)) this.NewLocationName = this.NewLocationName.Trim();
		...
		if(!string.IsNullOrEmpty(this.OldDepartmentName)) this.OldDepartmentName = this.OldDepartmentName.Trim();
		if(!string.IsNullOrEmpty(this.NewDepartmentName)) this.NewDepartmentName = this.NewDepartmentName.Trim();
		if(!string.IsNullOrEmpty(this.OldCategoryName)) this.OldCategoryName = this.OldCategoryName.Trim();
		if(!string.IsNullOrEmpty(this.OldProductName)) this.OldProductName = this.OldProductName.Trim();
		if(!string.IsNullOrEmpty(this.NewProductName)) this.NewProductName = this.NewProductName.Trim();
		if(!string.IsNullOrEmpty(this.oldSectionName)) this.oldSectionName = this.oldSectionName.Trim();
		if(!string.IsNullOrEmpty(this.NewSectionName)) this.NewSectionName = this.NewSectionName.Trim();
		if(!string.IsNullOrEmpty(this.NewCategoryName)) this.NewCategoryName = this.NewCategoryName.Trim();
    ...
    public static TransactionLineItemViewForTransfer GetItem(AMSContext _db, int id)
    {
        return (from b in _db.TransactionLineItemViewForTransfer
                where b.AssetID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<TransactionLineItemViewForTransfer> GetAllItemsByDepartment(AMSContext _db, int departmentID , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<TransactionLineItemViewForTransfer> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<TransactionLineItemViewForTransfer> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return from b in TransactionLineItemViewForTransfer.GetAllItems(_db, includeInactiveItems)
    ...
    {
        return (from b in _db.TransactionLineItemViewForTransfer select b);
    }
    ...
    {
        return TransactionLineItemViewForTransfer.GetAllItems(_db, includeInactiveItems);
    }

    IQueryable<BaseEntityObject> IACSDBObject.GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = true)
    {
        return TransactionLineItemViewForTransfer.GetAllUserItems(_db, userID, includeInactiveItems);
    }
