...
[Index("CompanyCode", Name = "UK_CompanyTable_CompanyCode", IsUnique = true)]
public partial class CompanyTable : BaseEntityObject, IACSDBObject
{
    [Key]
    ...
    [InverseProperty("CompanyTableCreatedByNavigation")]
    ...
    [InverseProperty("CompanyTableLastModifiedByNavigation")]
...
/*
	...
	/// <summary>
    /// Default constructor for CompanyTable
    /// </summary>
    /// <param name="db"></param>
	public CompanyTable(AMSContext _db)
	{
...
*/
    ...
    public static CompanyTable GetItem(AMSContext _db, int id)
    {
        return (from b in _db.CompanyTable
                where b.CompanyID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<CompanyTable> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
        if(includeInactiveItems)
        {
            return (from b in _db.CompanyTable
                    where b.StatusID != (int) StatusValue.Deleted 
                    orderby b.CompanyID descending
                    select b);
        }
        else
        {
    ...
    public static IQueryable<CompanyTable> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return CompanyTable.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.CompanyTable select b);
    }
    ...
    {
        return CompanyTable.GetAllUserItems(_db, userID, includeInactiveItems);
    }
