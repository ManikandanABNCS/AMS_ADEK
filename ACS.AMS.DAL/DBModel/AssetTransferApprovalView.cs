...
[Keyless]
public partial class AssetTransferApprovalView : BaseEntityObject, IACSDBObject
{
...
/*
    ...
    public AssetTransferApprovalView()
    {

    }

	/// <summary>
    /// Default constructor for AssetTransferApprovalView
    /// </summary>
    /// <param name="db"></param>
	public AssetTransferApprovalView(AMSContext _db)
	{
...
*/
    ...
    public static AssetTransferApprovalView GetItem(AMSContext _db, int id)
    {
        return (from b in _db.AssetTransferApprovalView
                where b.ApprovalHistoryID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<AssetTransferApprovalView> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<AssetTransferApprovalView> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return AssetTransferApprovalView.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.AssetTransferApprovalView select b);
    }
    ...
    {
        return AssetTransferApprovalView.GetAllUserItems(_db, userID, includeInactiveItems);
    }
