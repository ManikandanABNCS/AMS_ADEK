...
[Keyless]
public partial class LocationNewView : BaseEntityObject, IACSDBObject
{
...
/*
	...
	/// <summary>
    /// Default constructor for LocationNewView
    /// </summary>
    /// <param name="db"></param>
	public LocationNewView(AMSContext _db)
	{
...
*/
    ...
    public static LocationNewView GetItem(AMSContext _db, int? id)
    {
        return (from b in _db.LocationNewView
                where b.LocationID == id
                select b).FirstOrDefault();
    }

    public static IQueryable<LocationNewView> GetAllItems(AMSContext _db , bool includeInactiveItems = false )
    {
    ...
    public static IQueryable<LocationNewView> GetAllUserItems(AMSContext _db, int userID, bool includeInactiveItems = false)
    {
        return LocationNewView.GetAllItems(_db, includeInactiveItems);
    }
    ...
    {
        return (from b in _db.LocationNewView select b);
    }
    ...
    {
        return LocationNewView.GetAllUserItems(_db, userID, includeInactiveItems);
    }
